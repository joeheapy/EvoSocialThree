...
SIMULATION_MAX_EPOCHS = 200
SIMULATION_SUBSIDY_CAP = 0.15
SIMULATION_PENALTY_CAP = 0.10
SIMULATION_EPSILON = 0.01

# --- Simulation Tuning Parameters ---
SIMULATION_BASE_LEARNING_RATE = 0.05
SIMULATION_MAX_LEARNING_RATE = 0.3
SIMULATION_MIN_LEARNING_RATE = 0.01
SIMULATION_ADAPTIVE_CAP_S_MULTIPLIER = 5.0
SIMULATION_ADAPTIVE_CAP_P_MULTIPLIER = 4.0
